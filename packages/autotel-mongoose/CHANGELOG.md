...
- 5218b30: Choose which schema hooks to trace, and name their spans after the operation.
...
- aa0617f: fix(autotel-mongoose): stop callback-style hooks leaking their span context to sibling hooks
...
- bc281e3: fix(autotel-mongoose): stop corrupting hook args and leaking hook spans
