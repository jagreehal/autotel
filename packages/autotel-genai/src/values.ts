/**
 * Reading values that arrive from outside: an LLM SDK's result object, a
 * telemetry channel message, an error someone threw. Nothing about them is known until one
 ...
 * are what a boundary is made of; past it, the instrumentation works with types.
 *
