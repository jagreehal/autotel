...
name: autotel-edge
description: >
  Use this skill when adding OpenTelemetry to an edge runtime with no Node.js APIs (Cloudflare Workers, Vercel Edge, Deno) — trace(), span(), instrument(), sampling, events, and the request logger, kept bundle-size lean.
---
