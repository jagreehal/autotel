...
name: autotel-aws
description: >
  Use this skill when instrumenting AWS with OpenTelemetry — Lambda handlers, SDK v3 clients, S3, DynamoDB, SQS, SNS, Kinesis, Step Functions, and X-Ray, built on autotel.
---
