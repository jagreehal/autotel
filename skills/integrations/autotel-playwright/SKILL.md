...
description: >
  Use this skill when linking Playwright e2e tests to server-side traces — the fixture and reporter that create one OTel span per test and inject W3C trace context into API requests.
---
