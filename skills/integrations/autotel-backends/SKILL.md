...
description: >
  Use this skill when configuring autotel for a specific vendor backend — ready-made AutotelConfig presets for Honeycomb, Datadog, Google Cloud, and Grafana Cloud with best-practice defaults baked in.
---
