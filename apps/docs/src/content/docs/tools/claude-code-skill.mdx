...
The skill described above teaches Claude Code how to **write** instrumented code. Two integrations serve a second class of agent task, **investigating** telemetry: querying traces, diagnosing errors, and ranking expensive LLM calls. They are two interchangeable mechanisms:
