...
1. [`autotel-mcp`](/autotel/integrations/mcp/): an MCP server the user wires into `.mcp.json`.
...
- [`autotel-mcp`](/autotel/integrations/mcp/): the MCP server this CLI surface mirrors
