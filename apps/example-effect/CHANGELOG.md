...
- Updated dependencies [f039b65]
  - autotel-effect@5.0.2

## 1.0.69

### Patch Changes

- Updated dependencies [1265f07]
  - autotel-effect@5.0.1
...
- Added example-effect app: Autotel + Effect with Tracer.layerGlobal and Resource.layer.
