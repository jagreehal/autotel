...
- Updated dependencies [4c859aa]
  - autotel-posthog@1.1.0
  - autotel-web@1.13.1
  - autotel@7.0.1

## 0.0.1

Browser join of Autotel traces to PostHog sessions, with a checkout server
that reads `session.id` from W3C baggage.
